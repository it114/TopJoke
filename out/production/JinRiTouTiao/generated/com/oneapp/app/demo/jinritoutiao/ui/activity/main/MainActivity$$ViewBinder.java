...
public class MainActivity$$ViewBinder<T extends com.oneapp.app.demo.jinritoutiao.ui.activity.main.MainActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131034224, "field 'top_progress'");
    target.top_progress = finder.castView(view, 2131034224, "field 'top_progress'");
    view = finder.findRequiredView(source, 2131034223, "field 'top_refresh'");
    target.top_refresh = finder.castView(view, 2131034223, "field 'top_refresh'");
    ...
    view = finder.findRequiredView(source, 2131034217, "method 'showRightOrLeftPanel'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131034215, "method 'onUserHeadClick'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
