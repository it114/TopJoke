package com.oneapp.app.demo.jinritoutiao.view;
...
import com.oneapp.app.demo.jinritoutiao.ui.activity.SettingsActivity;
...
//		localSlidingMenu.setTouchModeBehind(SlidingMenu.SLIDING_CONTENT);//设置了这个会获取不到菜单里面的焦点，所以先注释掉
        localSlidingMenu.setShadowWidthRes(R.dimen.size_15);//设置阴影图片的宽度
        localSlidingMenu.setShadowDrawable(R.drawable.shadow);//设置阴影图片
        localSlidingMenu.setBehindOffsetRes(R.dimen.size_50);//SlidingMenu划出时主页面显示的剩余宽度
